...
export const Soldes = () => {
    ...
    const handleDeleteExpense = (expenseId) => {
        deleteExpense(ApiDelete, ApiGet, expenseId, toggleDetailsModal, setHistory, group);
    };

    const handleUpdateExpense = (expenseId, event, allParticipants) => {
        updateExpense(ApiPut, ApiGet, expenseId, event, allParticipants, toggleModifyExpenseModal, setFormError, setHistory, group);
    };
                    ...
                    <Modal visible={showFilterModal} onRequestClose={toggleFilterModal}>
                        <View style={styles.modalView}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) => setFilterCriteria({ ...filterCriteria, title: text })}
                            />
                            <TextInput
                                style={styles.input}
                                placeholder="Catégorie"
                                value={filterCriteria.category}
                                onChangeText={(text) => setFilterCriteria({ ...filterCriteria, category: text })}
                            />
                            <TextInput
                                style={styles.input}
                                ...
                                onChangeText={(text) => setFilterCriteria({ ...filterCriteria, minAmount: text })}
                            />
                            <TextInput
                                style={styles.input}
                                ...
                                onChangeText={(text) => setFilterCriteria({ ...filterCriteria, maxAmount: text })}
                            />

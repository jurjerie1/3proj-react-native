export const fetchExpenses = async (ApiGet, groupId, setHistory, filters = {}, setFormError) => {
    try {
        ...
        if (filters.minAmount) {
            queryParameters.push(`minAmount=${encodeURIComponent(filters.minAmount)}`);
        }
        if (filters.maxAmount) {
            queryParameters.push(`maxAmount=${encodeURIComponent(filters.maxAmount)}`);
        }

...
export const axiosUtils = () => {
  ...
  const config = {
    headers: {
      ...
      Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..3CMt1s5y8sXO8m1xZrmMg_JTX3SzwNr9RLQjP20Nqeg`,
    },
  };
